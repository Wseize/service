...
class PersonSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Person
        fields = ['id', 'name', 'category', 'image', 'phone_number', 'available', 'location', 'latitude', 'longitude', 'ratings', 'average_rating', 'notices', 'gallery']
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ['id', 'user', 'item', 'person', 'location', 'status', 'created_at', 'item_name', 'user_mobile', 'date_time', 'price', 'governorat', 'delivery_cost']
